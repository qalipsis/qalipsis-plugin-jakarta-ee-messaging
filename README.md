# <a src="https://qalipsis.io"><img src="http://assets.qalipsis.io/qalipsis-logo.png" style="height:60px;width:60px;position:relative;top:18px;margin-right:20px;"/>QALIPSIS for Jakarta</a>

![CI](https://github.com/qalipsis/qalipsis-plugin-jakarta-ee-messaging/actions/workflows/gradle-main.yml/badge.svg)
...
The QALIPSIS plugin for Jakarta is distributed under the GNU Affero General Public License 3.0, the terms can be
read [here](./LICENSE).
