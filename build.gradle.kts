            ...
            publications {
                create<MavenPublication>("maven") {
                    ...
                    pom {
                        ...
                        scm {
                            connection.set("scm:git:https://github.com/qalipsis/qalipsis-plugin-jakarta-ee-messaging.git")
                            url.set("https://github.com/qalipsis/qalipsis-plugin-jakarta-ee-messaging.git/")
                        }
                    }
                }
            }
